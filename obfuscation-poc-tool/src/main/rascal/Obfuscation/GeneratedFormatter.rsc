...
str format(arrayDeclarator(list[void] arg_1, Name arg_2, list[Expression] arg_3)) =
"<format(arg_2)><"<for (value v <- arg_3) {><format(v)><}>">";
...
str format(cast(Expression arg_1, Expression arg_2)) =
"(<format(arg_1)>)<format(arg_2)>";
